...
public sealed class OtpRequestConfiguration : IEntityTypeConfiguration<OtpRequest>
{
    public void Configure(EntityTypeBuilder<OtpRequest> builder)
    {
        ...
        builder.Property(o => o.HashedOtp).HasColumnName("hashed_otp").HasMaxLength(255).IsRequired();
        builder.Property(o => o.DeviceId).HasColumnName("device_id").HasMaxLength(255);
